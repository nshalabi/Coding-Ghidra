...
public class LibGhidra {
    ...
    /**
     * Runs headless command
     * @param headlessCmd
     * @param handler
     * @throws Exception
     */
    public static void runHeadlessCmd(String headlessCmd,
                                      LibProgramHandler handler) throws Exception {
        new LibGhidra(headlessCmd.split("\\s+"), handler);
    }

    /**
     * Run heqdless command (command line arguments)
     * @param headlessCmdArgs
     * @param handler
     * @throws Exception
     */
    public static void runHeadlessCmd(String [] headlessCmdArgs,
                                      LibProgramHandler handler) throws Exception {
        new LibGhidra(headlessCmdArgs, handler);
    }

    private LibGhidra(String args[], LibProgramHandler handler) throws Exception {
        ...
        if (args[0].startsWith("ghidra:")) {
            ...
            try {
                ...
                throw new Exception("Invalid Ghidra URL: " + args[0]);
            }
        } else {
            if (args.length < 2) {
                throw new Exception("Wrong number of arguments");
            ...
            if (folderIndex == 0) {
                throw new Exception(args[1] + " is an invalid project_name/folder_path.");
        ...
        LibHeadlessAnalyzer analyzer =
                LibHeadlessAnalyzer.getLoggableInstance(logFile, scriptLogFile, true, handler);
        ...
        try {
            ...
            Msg.error(LibHeadlessAnalyzer.class,
