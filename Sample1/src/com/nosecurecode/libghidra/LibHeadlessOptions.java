 ...
 * {@link LibHeadlessAnalyzer#processLocal(String, String, String, List)} or
 * {@link LibHeadlessAnalyzer#processURL(java.net.URL, List)} are performed,
 * these options should be reset and adjusted as necessary.
 */

public class LibHeadlessOptions {
